  ...
  <div class="auth-container">
    <div class="auth-left">
      ...
      <div class="info-description">
        Admin Portal for Campus Vote. Manage elections, voters, and view results. Access restricted to authorized administrators only.
      </div>
    </div>
    ...
    <div class="auth-right">
      <div class="login-card">
        ...
        <div class="login-footer">
          <router-link to="/voter/login" class="login-link">Login as Student</router-link>
        </div>
      </div>
    </div>
  </div>

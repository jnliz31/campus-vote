    ...
    <div class="auth-right">
      <div class="login-card">
        ...
        <div class="login-footer">
          <router-link to="/voter/register" class="login-link">Don't have an account? Register</router-link>
          <br>
          <router-link to="/admin/login" class="login-link">Login as Admin</router-link>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    async login() {
      ...
      try {
        const response = await authAPI.voterLogin(this.email, this.password);

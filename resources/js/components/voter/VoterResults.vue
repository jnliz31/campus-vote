              ...
              <div v-for="candidate in position.candidates" :key="candidate.id" class="candidate-result">
                ...
                <div class="progress-bar">
                  <div 
                    ...
                    <span v-if="candidate.percentage > 10" class="percentage">{{ candidate.percentage }}%</span>
                  </div>
                  <span v-if="candidate.percentage <= 10" class="percentage-outside">{{ candidate.percentage }}%</span>
                </div>
              </div>
            </div>
          </div>
